...
## Column wise NA values in data frames #####################
...
# Unable to Interpret from histogram properly So normlizing them
...
nrow(no_posts) # 87364
length(unique(no_posts$`Theme Id`)) # 154
...
# we can conclude mapping between produc_id and claim_id is not one on one. Since there are no NA values also.
